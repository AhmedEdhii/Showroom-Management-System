 ...
 * @author ahmed
 */
public class HR_dashboard_Bookings11 extends javax.swing.JFrame {
    ...
    public HR_dashboard_Bookings11() {
        initComponents();
    }

    public HR_dashboard_Bookings11(int emp_id) {
        initComponents();
        this.emp_id = emp_id;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HR_dashboard_Bookings11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HR_dashboard_Bookings11().setVisible(true);
            }
        });
    }
