 ...
 * @author ahmed
 */
public class HR_dashboard_services extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HR_dashboard_services.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HR_dashboard_services().setVisible(true);
            }
        });
    }
