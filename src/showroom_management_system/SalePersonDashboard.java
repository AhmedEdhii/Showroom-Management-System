 ...
 * @author ahmed
 */
public class SalePersonDashboard extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalePersonDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
