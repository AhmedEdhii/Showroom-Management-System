 ...
 * @author ahmed
 */
public class SalePersonDashboard1 extends javax.swing.JFrame {
    ...
    public SalePersonDashboard1() {
        initComponents();
    }

    public SalePersonDashboard1(int emp_id) {
        initComponents();
        this.emp_id = emp_id;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalePersonDashboard1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalePersonDashboard1().setVisible(true);
            }
        });
    }
