 ...
 * @author ahmed
 */
public class SalePersonDashboardBookings extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalePersonDashboardBookings.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
