 ...
 * @author ahmed
 */
public class adminDashboardServices extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminDashboardServices.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
