 ...
 * @author ahmed
 */
public class adminDashboardUsedCars extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        new UsedCarRecord(emp_id).setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminDashboardUsedCars.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
